 ...
 */
final class Version20220311175200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, date VARCHAR(10) NOT NULL, commentary VARCHAR(255) DEFAULT NULL, INDEX IDX_8F91ABF067B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
